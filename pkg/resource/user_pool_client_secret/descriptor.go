...
const (
	FinalizerString = "finalizers.cognitoidentityprovider.services.k8s.aws/UserPoolClientSecret"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("userpoolclientsecrets")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.UserPoolClientSecret{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.UserPoolClientSecret),
	}
}
