...
// +kubebuilder:rbac:groups=cognitoidentityprovider.services.k8s.aws,resources=userpoolclientsecrets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cognitoidentityprovider.services.k8s.aws,resources=userpoolclientsecrets/status,verbs=get;update;patch
